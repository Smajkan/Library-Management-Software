            ...
            Integer _quantity,String _publisher,double _price,String _date_received, String _description, byte[] _cover)
    {
        ...
        try {
            ...
            if(ps.executeUpdate()==1){
                JOptionPane.showMessageDialog(null, "Knjiga dodana", "Dodavanje knjige",1);
            }
            else{
                JOptionPane.showMessageDialog(null, "Dodavanje knjige neuspješno.", "Dodavanje knjige",2);
            }
